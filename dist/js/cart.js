...
// $(document).on('click', '.item_box', function(e) {
//     this.classList.toggle('sss');
// });

const targetCard = document.querySelectorAll('.item_box');

targetCard.forEach(user => {
  user.addEventListener('click', click, false);
});

function click() {
	$(this).addClass('openCart').siblings().removeClass('openCart')
}